...
function TTTT() {
   ...
   */
	...
	const geometry3 = new THREE.SphereGeometry(60, 40, 40);
  ...
  var mesh2 = new THREE.Mesh(geometry2, sphereMaterial1); //网格模型对象Mesh
  var mesh3 = new THREE.Mesh(geometry3, sphereMaterial2); //网格模型对象Mesh
